				...
				<div style={{ background: '#194a9a', height: 'auto' }}>
					...
					>
						...
						>
							...
							voluptatum non, aspernatur atque, sequi consectetur vero magni
							dolorem voluptatibus adipisci mollitia nulla. Ullam sint,
							architecto pariatur, voluptatibus error quibusdam sit ad voluptas,
							facilis libero tenetur dolor reprehenderit explicabo corporis.
							Saepe architecto culpa soluta aliquid illum pariatur aliquam sequi
							eligendi nostrum sunt temporibus, odit officiis voluptas accusamus
							est! Beatae error id in minima voluptatibus, nesciunt tempore
							ducimus doloremque sequi, nam temporibus vitae corporis,
							asperiores iusto ab maiores!
						</p>
						<div style={{ height: '2rem' }}></div>
						<Grid
							container
